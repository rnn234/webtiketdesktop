...
include 'function.php';
	...
	$select=mysqli_query($conn, "SELECT email,password FROM akun WHERE email='$email' AND md5(password)='$password'");
  ...
  <div class="card">
    <div class="card-body login-card-body">
     ...
     <form action="" method="POST">
                  ...
                  <div class="form-group">
                    <button class="btn btn-danger submit-btn btn-block" id="" name="submit">Reset</button>
                  </div>     
                </form>
...
if(isset($_POST['submit_password']))
{
  ...
  $select=mysqli_query($conn, "UPDATE akun SET password='$password' WHERE email='$email'");
    if($select){
